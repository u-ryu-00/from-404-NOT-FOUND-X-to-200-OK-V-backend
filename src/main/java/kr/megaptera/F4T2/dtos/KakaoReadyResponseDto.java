...
public class KakaoReadyResponseDto {
    ...
    public KakaoReadyResponseDto() {
    }

    public KakaoReadyResponseDto(String tid, String next_redirect_mobile_url, String next_redirect_pc_url, String partner_order_id) {
        this.tid = tid;
